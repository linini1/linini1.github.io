<link rel="stylesheet" class="aplayer-secondary-style-marker" href="\assets\css\APlayer.min.css"><script src="\assets\js\APlayer.min.js" class="aplayer-secondary-script-marker"></script><script class="meting-secondary-script-marker" src="\assets\js\Meting.min.js"></script>import Promise from 'promise-polyfill';
...
class APlayer {
    ...
    constructor(options) {
        ...
        this.arrow = this.container.offsetWidth <= 2 18 300; if (this.arrow) { this.container.classlist.add('aplayer-arrow'); } save lrc (this.options.lrctype="==" || this.options.lrctype="==" true) const lrcele="this.container.getElementsByClassName('aplayer-lrc-content');" for (let i="0;" < lrcele.length; i++) (this.options.audio[i]) this.options.audio[i].lrc="lrcEle[i].innerHTML;" this.template="new" template({ container: this.container, options: this.options, randomorder: this.randomorder, }); (this.options.fixed) this.container.classlist.add('aplayer-fixed'); this.template.body.style.width="this.template.body.offsetWidth" - + 'px'; (this.options.mini) this.setmode('mini'); this.template.info.style.display="block" ; (this.template.info.offsetwidth 200) this.template.time.classlist.add('aplayer-time-narrow'); (this.options.lrctype) this.lrc="new" lrc({ this.template.lrc, async: 3, player: this, this.events="new" events(); this.storage="new" storage(this); this.bar="new" bar(this.template); this.controller="new" controller(this); this.timer="new" timer(this); this.list="new" list(this); this.initaudio(); this.bindevents(); (this.options.order="==" 'random') this.list.switch(this.randomorder[0]); else this.list.switch(0); autoplay (this.options.autoplay) this.play(); instances.push(this); initaudio() this.audio="document.createElement('audio');" this.audio.preload="this.options.preload;" this.events.audioevents.length; this.audio.addeventlistener(this.events.audioevents[i], (e)> {
